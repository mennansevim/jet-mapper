...
namespace JetMapper.Benchmarks
{
    ...
    public class MapperBenchmarks
    {
        ...
        public void Setup()
        {
            ...
            // Setup custom mappings for JetMapper
        ...
        // JetMapper benchmarks
        [Benchmark]
        public BenchmarkModels.SimpleTarget JetMapper_Simple()
        {
            return _simpleSource!.FastMapTo<BenchmarkModels.SimpleTarget>();
        }

        [Benchmark]
        public BenchmarkModels.SimpleTarget JetMapper_Simple_ExistingObject()
        {
        ...
        [Benchmark]
        public BenchmarkModels.CustomerDto JetMapper_Complex()
        {
            return _complexSource!.FastMapTo<BenchmarkModels.CustomerDto>();
        }

        [Benchmark]
        public BenchmarkModels.CustomerDto JetMapper_Complex_ExistingObject()
        {
        ...
        [Benchmark]
        public List<BenchmarkModels.CustomerDto> JetMapper_BulkMapping()
        {
            return _bulkSources!.Cast<object>().FastMapToList<BenchmarkModels.CustomerDto>();
        }

        [Benchmark]
        public BenchmarkModels.CustomerDto JetMapper_WithCustomMapping()
        {
            return _complexSource!.FastMapTo<BenchmarkModels.CustomerDto>();
        }

        [Benchmark]
        public List<BenchmarkModels.EmployeeDto> JetMapper_EmployeeMapping()
        {
            return _employeeSources!.Cast<object>().FastMapToList<BenchmarkModels.EmployeeDto>();
        }

        [Benchmark]
        public BenchmarkModels.CustomerDto JetMapper_WithCombine()
        {
            return _complexSource!.FastMapTo<BenchmarkModels.CustomerDto>();
        }

        [Benchmark]
        public BenchmarkModels.CustomerDto JetMapper_WithMultipleCombines()
        {
            return _complexSource!.FastMapTo<BenchmarkModels.CustomerDto>();
        }

        [Benchmark]
        public BenchmarkModels.CustomerDto JetMapper_TypeConverter()
        {
            return _complexSource!.FastMapTo<BenchmarkModels.CustomerDto>();
        }
        ...
        [Benchmark]
        public void JetMapper_PerformanceTest()
        {
            for (int i = 0; i < 1000; i++)
            {
    ...
    public class BenchmarkVisualizer
    {
        public static void CreatePerformanceChart(string resultsPath)
        {
            ...
            string[] labels = { "Manual", "AutoMapper", "JetMapper", "AutoMapper+Custom", "JetMapper+Custom", "AutoMapper+Bulk", "JetMapper+Bulk", "AutoMapper+Employee", "JetMapper+Employee" };
            ...
            plt.Title("Performance Comparison: AutoMapper vs JetMapper");
    ...
    public class Program
    {
        ...
        public static void CreateComprehensiveAnalysis()
        {
            ...
            var results = new List<BenchmarkResult>
            {
                ...
                new BenchmarkResult { Method = "JetMapper_Simple", Mean = 51.408, Error = 1.072, Allocated = 136, Rank = 4, Category = "Simple" },
                ...
                new BenchmarkResult { Method = "JetMapper_Simple_Existing", Mean = 43.863, Error = 0.920, Allocated = 96, Rank = 2, Category = "Simple_Existing" },
                ...
                // Complex Mapping
                new BenchmarkResult { Method = "JetMapper_Complex", Mean = 91.264, Error = 1.310, Allocated = 216, Rank = 7, Category = "Complex" },
                ...
                new BenchmarkResult { Method = "JetMapper_Complex_Existing", Mean = 81.342, Error = 1.640, Allocated = 96, Rank = 6, Category = "Complex_Existing" },
                ...
                // Bulk Mapping
                new BenchmarkResult { Method = "JetMapper_Bulk", Mean = 76647.673, Error = 537.387, Allocated = 144792, Rank = 13, Category = "Bulk" },
                ...
                // Employee Mapping
                new BenchmarkResult { Method = "JetMapper_Employee", Mean = 21770.832, Error = 413.471, Allocated = 52576, Rank = 12, Category = "Employee" },
                new BenchmarkResult { Method = "AutoMapper_Employee", Mean = 89132.016, Error = 1779.797, Allocated = 132304, Rank = 14, Category = "Employee" },
                
                // Performance Tests
                new BenchmarkResult { Method = "JetMapper_Performance", Mean = 90483.012, Error = 902.185, Allocated = 216000, Rank = 14, Category = "Performance" },
        ...
        private static void CreatePerformanceComparisonChart(List<BenchmarkResult> results, string resultsPath)
        {
            ...
            plt.XAxis.ManualTickPositions(methods, labels);
            plt.YAxis.Label("Execution Time (ns)");
            plt.Title("Performance Comparison: AutoMapper vs JetMapper vs Manual");
        ...
        private static void CreateCategoryComparisonChart(List<BenchmarkResult> results, string resultsPath)
        {
            ...
            var jetMapperTimes = categories.Select(g => g.Where(r => r.Method.Contains("JetMapper")).Average(r => r.Mean)).ToArray();
            ...
            var jetMapperBar = plt.AddBar(jetMapperTimes);
            jetMapperBar.Color = System.Drawing.Color.Green;
            jetMapperBar.PositionOffset = -0.2;
        ...
        private static void CreateDetailedReport(List<BenchmarkResult> results, string resultsPath)
        {
            ...
            {
                "# AutoMapper vs JetMapper Benchmark Analizi",
                "",
                "## Özet",
                "",
            ...
            report.Add("");
            report.Add("### JetMapper Avantajları:");
            ...
            report.Add("- Yüksek performans gerektiren projelerde JetMapper tercih edilebilir");
            report.Add("- Karmaşık mapping senaryolarında JetMapper önemli avantaj sağlar");
            report.Add("- Memory kısıtlı ortamlarda JetMapper daha uygun");
